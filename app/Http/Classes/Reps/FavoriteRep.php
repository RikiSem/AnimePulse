...
class FavoriteRep
{
    ...
    public function getOne(string $entityType, int $entityId, int $userId): Favorites | null
    {
    ...
    public function add(string $entityType, int $entityId, int $userId) {
    ...
    public function remove(int $entityId, int $userId) {
