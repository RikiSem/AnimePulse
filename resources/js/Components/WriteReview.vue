<template>
    <div class="create-review-form">
        <div class="review-text-editor">
            <review-text-input @textChange="data => this.reviewData.text = data.ops" :content="this.reviewText"></review-text-input>
        </div>
        <div class="review-mark-editor">
            ...
            <div class="marks">
                <review-mark
                    ...
                    @delete="deleteMark" v-for="(mark, index) in this.reviewData.marks"
                    :id="index"
                    :name="mark.name"
                    :mark="mark.mark"
                ></review-mark>
...
export default {
    ...
    methods:{
        ...
        async sendReviewData(){
            ...
            await (axios.post(route('review.create'), this.reviewData))
            this.$emit('close')
        }
    }
}
